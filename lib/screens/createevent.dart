    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: Padding(
          ...
          child: SingleChildScrollView( // wrapped by ScrollView to avoid overflow when keyboard overlaps buttons
            child: Column(
              children: [
                const Text('Seleziona il tipo di percosro'),
                FutureBuilder(
                  future: FirebaseDatabase.instance.ref().child('routes').once(),
